    ...
    <form enctype="multipart/form-data" action="{{ route('admin.update.guidance', $guidance->id) }}" method="post" class="w-full max-w-3xl bg-white rounded-lg p-8 shadow">
        ...
        <div class="block md:flex align-center justify-between my-2 gap-5">
            ...
            <div class="md:w-1/2 w-full">
                ...
                <input type="text" id="extension_name" name="extension_name" class="form-input w-full rounded border-gray-300 @error('extension_name') border-red-500 @enderror" value="{{ old('extension_name') ?? $guidance->extension_name }}">
        ...
        <div class="block md:flex align-center justify-between my-2 gap-5">
            ...
            <div class="md:w-1/2 w-full">
                ...
                <input type="tel" id="phone_number" name="phone_number" oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);"  class="form-input w-full rounded border-gray-300 @error('phone_number') border-red-500 @enderror" value="{{ old('phone_number') ?? $guidance->phone_number }}">
                @error('phone_number')
                <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
