...
@section('content')
    <form action="{{ route('admin.verify.otp') }}" method="post"
        ...
        @csrf
        <h2 class="text-2xl font-bold mb-6 mt-5 text-rose-900">Verification</h2>
        <div class="mb-4">
        ...
        <div>
            ...
            <p class="text-center mt-2 text-slate-500">Didn't received code? <a href="{{ route('admin.password.request') }}"
                    class="text-blue-700 hover:underline">Resend</a></p>
        </div>
    </form>
@endsection
