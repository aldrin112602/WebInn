...
@section('content')
    ...
    <div class="p-4">
        ...
        @else
            ...
            <form id="delete-selected-form" action="{{ route('student.deleteSelected.notifications') }}" method="POST">
                @csrf
                @method('DELETE')
                    ...
                    @foreach ($notifications as $notification)
                        <div
                            ...
                            <form id="delete_form_{{ $notification->id }}"
                                action="{{ route('student.notifications.delete', $notification->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
