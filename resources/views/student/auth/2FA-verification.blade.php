...
@section('content')
    <form action="{{ route('student.2fa.verify') }}" method="post"
        ...
        <div class="mb-6">
            ...
            <div id="otp-container" class="flex justify-between">
                ...
                <input autofocus type="text" maxlength="1"
                    class="otp-box form-input w-12 h-12 text-center rounded-lg focus:ring-2 focus:ring-rose-700 @error('otp') border-red-500 @enderror">
        ...
        <div>
            ...
            <p class="text-center mt-4 text-sm text-gray-500">Didn't receive the code? <a
                    href="{{ route('student.2fa.resend') }}" id="resendLink" class="text-blue-600 hover:underline"
