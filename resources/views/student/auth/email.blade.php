...
@section('content')
<form action="{{ route('student.password.otp') }}" method="post" class="w-full max-w-md bg-white rounded-lg p-8">
    @csrf
    ...
    <div>
        ...
        <p class="text-center mt-3 text-slate-500"><a href="{{ route('student.login') }}" class="text-slate-400 hover:underline text-sm font-semibold">Back to login</a></p>
    </div>
</form>
@endsection
