...
@section('content')
    <form action="{{ route('student.password.otp') }}" method="post"
        ...
        <p class="text-sm text-gray-400 mb-4">Enter your email for the verification proccess, we will send 4 digits code to
            your email</p>
        <div class="mb-4">
        ...
        <div>
            ...
            <p class="text-center mt-3 text-slate-500"><a href="{{ route('student.login') }}"
