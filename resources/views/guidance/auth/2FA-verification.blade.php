...
@section('content')
<form action="{{ route('guidance.2fa.verify') }}" method="post" class="w-full max-w-md bg-white rounded-lg p-8 mx-auto mt-10 shadow-lg" style="box-shadow: 0 0 0 100vw rgba(0, 0, 0, 0.6);">
    @csrf
    ...
    <div>
        ...
        <p class="text-center mt-4 text-sm text-gray-500">Didn't receive the code? <a href="{{ route('guidance.2fa.resend') }}" id="resendLink" class="text-blue-600 hover:underline" style="pointer-events: none; opacity: 0.5;">Resend Code</a></p>
    </div>
</form>
<script>
    document.addEventListener('DOMContentLoaded', function() {
