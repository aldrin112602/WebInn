...
@section('content')
    <div class="text-slate-100 p-2 bg-blue-400 flex items-center justify-between gap-4">
        ...
        <form action="{{ route('guidance.notifications.markAllAsRead') }}" method="POST">
            @csrf
    ...
    <div class="p-4">
        ...
        @else
            ...
            <form id="delete-selected-form" action="{{ route('guidance.deleteSelected.notifications') }}" method="POST">
                @csrf
                @method('DELETE')
                    ...
                    @foreach ($notifications as $notification)
                        <div
                            ...
                            <form id="delete_form_{{ $notification->id }}"
                                action="{{ route('guidance.notifications.delete', $notification->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
