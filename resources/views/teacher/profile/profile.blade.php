    ...
    <div class="md:px-20 px-10">
        <div class="block md:flex items-center justify-between">
            <div class="flex my-2 items-center justify-start gap-3">
                <form action="{{ route('teacher.updateProfilePhoto') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                    @csrf
            ...
            <div class="flex my-2 items-center justify-start gap-3">
                ...
                <form action="{{ route('teacher.deleteProfilePhoto') }}" method="POST" id="deleteForm" style="display:inline;">
                    @csrf
                    @method('DELETE')
