...
@section('content')
<form action="{{ route('teacher.verify.otp') }}" method="post" class="w-full max-w-md bg-white rounded-lg p-8 mx-auto mt-10">
    @csrf
    ...
    <div>
        ...
        <p class="text-center mt-2 text-slate-500">Didn't received code? <a href="{{ route('teacher.password.request') }}" class="text-blue-700 hover:underline">Resend</a></p>
    </div>
</form>
@endsection
